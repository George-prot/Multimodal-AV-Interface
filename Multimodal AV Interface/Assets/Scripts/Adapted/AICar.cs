...
public class AICar : MonoBehaviour, IVehicle
{
    ...
    //private ButtonState currButtonState = ButtonState.Idle;
    //private UIGazeButtonGraphics eyeGazeButtonGraphics;


    //UIGazeButtonGraphics egw = new UIGazeButtonGraphics();
    ...
    void Start()
    {
        ...
        //eyeGazeButtonGraphics = GetComponent<UIGazeButtonGraphics>();
        ...
        GameObject.FindGameObjectWithTag("Manager").active = false;
    ...
    void Update()
    {
        ...
        //dokimes
        //Debug.Log("prin "+currButtonState);

        //Debug.Log("meta " + currButtonState);

        //if(GameObject.FindWithTag("EyeGazeButton").GetComponent<ButtonState>().Fo)
        //egw.AnimateButtonVisualFeedback(GameObject.FindWithTag("EyeGazeButton").GetComponent<ButtonState>()); 
    }
    ...
    void FixedUpdate()
    {
       ...
       /* Debug.Log("----------------------------------------");
        ...
        //Debug.Log("rotation " + rotationAxis.rotation);
       ...
       /* Debug.Log("angular velocity " + theRigidbody.angularVelocity);
        Debug.Log("----------------------------------------");*/
        ...
        if ((braking == false) && (reset == false))
        {
            ...
            //Debug.Log("ROTATIONNNNNNNNNNN: " + model.localRotation);
    ...
    void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.CompareTag("WP"))
        {
            ...
            {
                if (other.transform.name == "Waypoint 002" || other.transform.name == "Waypoint 008") //left turn
                {
                ...
                else if(other.transform.name == "Waypoint 014")
                {
                    Vector3 newTarget = new Vector3(-69, 0, 133);
