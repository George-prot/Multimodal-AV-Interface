...
public class AICarSyncSystem
{
    ...
    public AICar Spawn(CarSpawnParams parameters, bool yielding)
    {
        ...
        //var items = SerializedProperty.FindPropertyRelative(waypointProgressTracker.circuit.Waypoints.ToString());
        //waypointProgressTracker.drawer.ImportFromFile(SerializedProperty.FindPropertyRelative("items").serializedObject);
