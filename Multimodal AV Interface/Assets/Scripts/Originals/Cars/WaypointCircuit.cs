...
namespace UnityStandardAssets.Utility
{
    public class WaypointCircuit : MonoBehaviour
    {
        ...
        UnityStandardAssets.Utility.Inspector.WaypointListDrawer one;
        ...
        /*public void Update()
        {
            Debug.Log("waypoint LISTTTT: " + waypointList.items.Length);
...
namespace UnityStandardAssets.Utility.Inspector
{
    ...
    public class WaypointListDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            /*GUI.Button(importButtonRect, "Import from file");
            ImportFromFile(items.serializedObject);*/
            y += lineHeight + spacing;
        ...
        public void ImportFromFile(SerializedObject circuitObject)
        {
            string fileName = "C:/Users/SURREAL TEAM/waypoints.csv";
            //var path = EditorUtility.OpenFilePanel("Import from", "./", "csv");
            //var path = Resources.Load<TextAsset>("./waypoints.csv").ToString();
            ...
            /*WaypointCircuit.WaypointList wList=new WaypointCircuit.WaypointList();
            for (int i = 0; i == wpts.arraySize; i++) {
                wList.items.SetValue(wpts.GetArrayElementAtIndex(i),i);
            }

            WaypointProgressTracker wpTracker = new WaypointProgressTracker();
            wpTracker.circuit = wList.circuit;*/

            //wpTracker.Init(wList.circuit);
        }
