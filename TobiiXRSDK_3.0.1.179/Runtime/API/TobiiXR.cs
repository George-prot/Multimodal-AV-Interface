...
namespace Tobii.XR
{
    ...
    public static class TobiiXR
    {
        ...
        //public static Vector2 rayPointer;
        ...
        private static void Tick()
        {
            ...
            if (Internal.Filter != null && Internal.Filter.enabled)
            {
                ...
                /*if (GameObject.FindGameObjectWithTag("Head") != null)
                {
                    ...
                    _eyeTrackingDataWorld.GazeRay.Origin = GameObject.FindGameObjectWithTag("Head").transform.position;
                }*/
            }
        ...
        private static G2OM_DeviceData CreateG2OMData(TobiiXR_EyeTrackingData data)
        {
            ...
            //Ray eyeRay = new Ray(data.GazeRay.Origin, data.GazeRay.Direction);
