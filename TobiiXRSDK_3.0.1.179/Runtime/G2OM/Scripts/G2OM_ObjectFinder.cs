...
namespace Tobii.G2OM
{
    ...
    public class G2OM_ObjectFinder : IG2OM_ObjectFinder
    {
        ...
        public void GetRelevantGazeObjects(ref G2OM_DeviceData deviceData, Dictionary<int, GameObject> foundObjects, IG2OM_ObjectDistinguisher distinguisher)
        {
            ...
            //Debug.Log(numberOfRaysThisFrame);
            ...
            int numberOfRaysThisFrame)
        {
            ...
            for (int i = 0; i < numberOfRaysThisFrame; i++)
            {
                ...
                //Debug.Log("mpika1");
                GameObject go;
                //Debug.Log("ray: " + rays[i].ray + ", layer: " + layerMask.value);
        ...
        private static bool FindGameObject(ref G2OM_Ray ray, LayerMask layerMask, out GameObject gameObject)
        {
            ...
            RaycastHit hit;
            /*
            Debug.Log("ray origin: "+ ray.origin.Vector());
            Debug.Log("ray direction: " + ray.direction.Vector());

            Debug.Log("-------------------------------------------------------------------------------------------");*/
            //Debug.Log(out hit.collider.gameObject);
            ...
            {
                Debug.Log("mpika rayyyyyyyyy");
                Debug.DrawRay(ray.origin.Vector(), ray.direction.Vector(), Color.green, 10);
            }*/
            ...
            //ta thelw
            //if (GameObject.FindGameObjectWithTag("Head") == null) return false;
            //if (Physics.Raycast(GameObject.FindGameObjectWithTag("Head").transform.position, ray.direction.Vector(), out hit, RaycastLength, layerMask) == false) return false;
            ...
            //Physics.Raycast(ray.origin.Vector(), ray.direction.Vector(), out hit, RaycastLength, layerMask);
